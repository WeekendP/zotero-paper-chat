...
An AI-powered conversational paper analysis plugin for Zotero 7, powered by free Google's Gemini Models.
...
1.  **Download**: Get the latest `.xpi` file from the [Releases](https://github.com/WeekendP/zotero-paper-chat/releases) page.
2.  **Install**:
    - Open Zotero.
    - Go to **Tools → Add-ons**.
...
- ☕ **[Buy Me a Coffee](https://www.buymeacoffee.com/WeekendP)** 
- 💖 **[Sponsor on GitHub](https://github.com/sponsors/WeekendP)**
